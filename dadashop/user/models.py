...
#     username = models.OneToOneField(UserProfile, verbose_name=u'用户名', null=True)
#     uid = models.CharField(verbose_name=u'微博uid', max_length=10)
#     access_token = models.CharField(verbose_name=u'授权码',max_length=21)
#     class Meta:
#         db_table = 'weibouser'
#         verbose_name = '微博用户表'
#         verbose_name_plural = verbose_name
